...
describe('playground.cul.js benchmarking single policy projections via calcudata', async () => {
  ...
  bench('thing', () => {
    calcudata({
        ...
        outputs: [
          'pv_premiums','pv_claims','pv_commissions', 'pv_expenses', 'pv_placeholder', 'pv_placeholder2'
        ],
      })
  })
