...
export const s0_mort_rate_select_index$ = ({ duration_mth_0_in, t_in }) => Math.max(0, Math.min(5, s0_duration({ duration_mth_0_in, t_in }))); // used to lookup mort_rate table
...
export const s0_lapse_rate_mth$ = ({ t_in, zero_decrement_experience_in, duration_mth_0_in }) => {// factored from pols_lapse
  if (s0_t({ t_in }) < 0 && s0_zero_decrement_experience({ zero_decrement_experience_in })) return 0;
...
export const s0_pols_if_at$ = ({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => {
  ...
  if (s0_timing({ timing_in }) == 'BEF_MAT') {
    ...
    return s0_pols_if_at({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, t_in: s0_t({ t_in }) - 1, timing_in: 'BEF_DECR' }) - s0_pols_lapse({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, t_in: s0_t({ t_in }) - 1 }) - s0_pols_death({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, t_in: s0_t({ t_in }) - 1 });
  }
  ...
  if (s0_timing({ timing_in }) == 'BEF_DECR') return s0_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: 'BEF_NB' }) + s0_pols_new_biz({ duration_mth_0_in, t_in, policy_count_in });
  return console.error('bad timing_in !');
};

export const s0_pols_lapse$ = ({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => s0_is_active({ duration_mth_0_in, t_in, policy_term_in }) ? (s0_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: 'BEF_DECR' }) - s0_pols_death({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in })) * s0_lapse_rate_mth({ t_in, zero_decrement_experience_in, duration_mth_0_in }) : 0;
...
export const s0_pols_new_biz$ = ({ duration_mth_0_in, t_in, policy_count_in }) => {
  if (s0_duration_mth({ duration_mth_0_in, t_in }) == 0)
  return s0_policy_count({ policy_count_in });else
  return 0;
};

export const s0_pols_death$ = ({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => s0_is_active({ duration_mth_0_in, t_in, policy_term_in }) ? s0_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: 'BEF_DECR' }) * s0_mort_rate_mth({ t_in, zero_decrement_experience_in, age_at_entry_in, duration_mth_0_in }) : 0;
...
export const s0_proj_len$ = ({ policy_term_in, duration_mth_0_in }) => Math.max(12 * s0_policy_term({ policy_term_in }) - s0_duration_mth({ duration_mth_0_in, t_in: 0 }) + 1, 0);

// todo think re actuals (new)
export const s0_is_active$ = ({ duration_mth_0_in, t_in, policy_term_in }) => !(s0_duration_mth({ duration_mth_0_in, t_in }) < 0 || s0_duration_mth({ duration_mth_0_in, t_in }) > s0_policy_term({ policy_term_in }) * 12);
...
export const s0_net_premium_pp$ = ({ policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in }) => {
  return -s0_pv_fut_claims({ policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, t_in: 0, duration_mth_0_in: 0 }) / s0_pv_fut_pols_if({ policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, t_in: 0, duration_mth_0_in: 0 });
};
...
export const s1_mort_rate$ = ({ age_at_entry_in, duration_mth_0_in, t_in }) => s1_mort_table({}).find((d) => d.Age == s0_age({ age_at_entry_in, duration_mth_0_in, t_in }))[s0_mort_rate_select_index({ duration_mth_0_in, t_in })];
