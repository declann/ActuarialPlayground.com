...
export const s0_claim_pp$ = ({ sum_assured_in }) => s0_sum_assured({ sum_assured_in });
...
export const s0_mort_rate_mth$ = ({ t_in, zero_decrement_experience_in, age_at_entry_in, duration_mth_in }) => {
  ...
  return 1 - (1 - s1_mort_rate({ age_at_entry_in, duration_mth_in, t_in })) ** (1 / 12);
};

// lapse rates
// tihs formula can get updated in the UI:
export const s0_lapse_rate$ = ({ duration_mth_in, t_in }) => Math.max(0.1 - 0.02 * s0_duration({ duration_mth_in, t_in }), 0.02);

export const s0_lapse_rate_mth$ = ({ t_in, zero_decrement_experience_in, duration_mth_in }) => {// factored from pols_lapse
  if (s0_t({ t_in }) < 0 && s0_zero_decrement_experience({ zero_decrement_experience_in })) return 0;
  return 1 - (1 - s0_lapse_rate({ duration_mth_in, t_in })) ** (1 / 12);
};
...
export const s0_pols_if_at$ = ({ duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => {
  if (s0_is_active({ duration_mth_in, t_in, policy_term_in }) == 0) return 0;
  if (s0_timing({ timing_in }) == 'BEF_MAT') {
    if (s0_t({ t_in }) == 0 && s0_pols_if_init({ policy_count_in }) && 0 /* DN: disabling */)
    return s0_pols_if_init({ policy_count_in });
    return s0_pols_if_at({ duration_mth_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, t_in: s0_t({ t_in }) - 1, timing_in: 'BEF_DECR' }) - s0_pols_lapse({ duration_mth_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, t_in: s0_t({ t_in }) - 1 }) - s0_pols_death({ duration_mth_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, t_in: s0_t({ t_in }) - 1 });
  }
  if (s0_timing({ timing_in }) == 'BEF_NB') {
    return s0_pols_if_at({ duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: 'BEF_MAT' }) - s0_pols_maturity({ duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in });
  }
  if (s0_timing({ timing_in }) == 'BEF_DECR') return s0_pols_if_at({ duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: 'BEF_NB' }) + s0_pols_new_biz({ duration_mth_in, t_in, policy_count_in });
  return console.error('bad timing_in !');
};

export const s0_pols_lapse$ = ({ duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => s0_is_active({ duration_mth_in, t_in, policy_term_in }) ? (s0_pols_if_at({ duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: 'BEF_DECR' }) - s0_pols_death({ duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in })) * s0_lapse_rate_mth({ t_in, zero_decrement_experience_in, duration_mth_in }) : 0;


// refactor for stress and experience logic


export const s0_pols_maturity$ = ({ duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => {
  if (s0_duration_mth({ duration_mth_in, t_in }) == s0_policy_term({ policy_term_in }) * 12)
  return s0_pols_if_at({ duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: 'BEF_MAT' });else
  return 0;
};

export const s0_pols_new_biz$ = ({ duration_mth_in, t_in, policy_count_in }) => {
  if (s0_duration_mth({ duration_mth_in, t_in }) == 0)
  return s0_policy_count({ policy_count_in });else
  return 0;
};

export const s0_pols_death$ = ({ duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => s0_is_active({ duration_mth_in, t_in, policy_term_in }) ? s0_pols_if_at({ duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: 'BEF_DECR' }) * s0_mort_rate_mth({ t_in, zero_decrement_experience_in, age_at_entry_in, duration_mth_in }) : 0;

// monthly
export const s0_premium_pp$ = ({ sum_assured_in, age_at_entry_in, policy_term_in }) => Math.round(s0_sum_assured({ sum_assured_in }) / 1000 * s0_premium_rate_per_mille({ age_at_entry_in, policy_term_in }) * 100) / 100; // round 2 decimal places


export const s0_expense_acq$ = ({}) => 300;
export const s0_expense_maint$ = ({}) => 60;

export const s0_inflation_rate$ = ({}) => 0.01;
export const s0_inflation_rate_mth$ = ({}) => (1 + s0_inflation_rate({})) ** (1 / 12) - 1;

export const s0_inflation_factor$ = ({ t_in }) => (1 + s0_inflation_rate({})) ** (s0_t({ t_in }) / 12); // in playground.cul.js adding support for inflation rates that vary over time: e.g. when we delay/stress the rate, and starting inflation at policy start rather than t=0 or "now"
...
export const s0_commission_pc$ = ({}) => 100;

// careful: manipulation in net_cf not captured in Playground outputs!
export const s0_net_cf$ = ({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in }) => s0_premiums({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in }) + s0_claims({ sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) + s0_expenses({ duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in }) + s0_commissions({ duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in });


export const s0_proj_len$ = ({ policy_term_in, duration_mth_in }) => Math.max(12 * s0_policy_term({ policy_term_in }) - s0_duration_mth({ duration_mth_in, t_in: 0 }) + 1, 0);

// todo think re actuals (new)
export const s0_is_active$ = ({ duration_mth_in, t_in, policy_term_in }) => !(s0_duration_mth({ duration_mth_in, t_in }) < 0 || s0_duration_mth({ duration_mth_in, t_in }) > s0_policy_term({ policy_term_in }) * 12);

export const s0_pols_if$ = ({ duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => s0_pols_if_at({ duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) /*{ timing_in: 'BEF_MAT' }*/;
...
export const s0_net_premium_pp$ = ({ policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in }) => {
  return -s0_pv_fut_claims({ policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, t_in: 0, duration_mth_in: 0 }) / s0_pv_fut_pols_if({ policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, t_in: 0, duration_mth_in: 0 });
};

export const s0_premium_rate_per_mille$ = ({ age_at_entry_in, policy_term_in }) =>
s1_premium_rate({ age_at_entry_in, policy_term_in }) * 1000; // uses table from basicterm-tables.cul.js
...
export const s0_disc_rate_ann$ = ({ t_in }) => {
  if (s0_t({ t_in }) <= 0) return 0;else
  return s1_zero_spot({ zero_spot_year_in: Math.floor(s0_t({ t_in }) / 12) });
};

export const s0_disc_rate_mth$ = ({ t_in }) => (1 + s0_disc_rate_ann({ t_in })) ** (1 / 12) - 1;

export const s0_disc_factor$ = ({ t_in }) => (1 + s0_disc_rate_mth({ t_in })) ** -s0_t({ t_in });
...
export const s0_pv_claims$ = ({ sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => s0_claims({ sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) * s0_disc_factor({ t_in });
export const s0_pv_premiums$ = ({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in }) => s0_premiums({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in }) * s0_disc_factor({ t_in });
export const s0_pv_expenses$ = ({ duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in }) => s0_expenses({ duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in }) * s0_disc_factor({ t_in });
export const s0_pv_commissions$ = ({ duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in }) => s0_commissions({ duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in }) * s0_disc_factor({ t_in });
export const s0_pv_net_cf$ = ({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in }) => s0_net_cf({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in }) * s0_disc_factor({ t_in });
export const s0_pv_pols_if$ = ({ duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => s0_pols_if({ duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) * s0_disc_factor({ t_in }); // BasicTerm_M, for pricing table calc reconciliation

// 2. pv_fut_x is sum of future present values >= t:
export const s0_pv_fut_claims$ = ({ t_in, policy_term_in, duration_mth_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in }) => {
  if (s0_t({ t_in }) >= s0_proj_len({ policy_term_in, duration_mth_in })) return 0;
  return s0_pv_fut_claims({ policy_term_in, duration_mth_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, t_in: s0_t({ t_in }) + 1 }) + s0_pv_claims({ sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in });
};

export const s0_pv_fut_premiums$ = ({ t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in }) => {
  if (s0_t({ t_in }) >= s0_proj_len({ policy_term_in, duration_mth_in })) return 0;
  return s0_pv_fut_premiums({ policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in, t_in: s0_t({ t_in }) + 1 }) + s0_pv_premiums({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in });
};

export const s0_pv_fut_expenses$ = ({ t_in, policy_term_in, duration_mth_in, policy_count_in, timing_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in }) => {
  if (s0_t({ t_in }) >= s0_proj_len({ policy_term_in, duration_mth_in })) return 0;
  return s0_pv_fut_expenses({ policy_term_in, duration_mth_in, policy_count_in, timing_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, t_in: s0_t({ t_in }) + 1 }) + s0_pv_expenses({ duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in });
};

export const s0_pv_fut_commissions$ = ({ t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in }) => {
  if (s0_t({ t_in }) >= s0_proj_len({ policy_term_in, duration_mth_in })) return 0;
  return s0_pv_fut_commissions({ policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in, t_in: s0_t({ t_in }) + 1 }) + s0_pv_commissions({ duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in });
};

export const s0_pv_fut_net_cf$ = ({ t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in }) => {
  if (s0_t({ t_in }) >= s0_proj_len({ policy_term_in, duration_mth_in })) return 0;
  return s0_pv_fut_net_cf({ policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in, t_in: s0_t({ t_in }) + 1 }) + s0_pv_net_cf({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in });
};

export const s0_pv_fut_pols_if$ = ({ t_in, policy_term_in, duration_mth_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in }) => {
  if (s0_t({ t_in }) >= s0_proj_len({ policy_term_in, duration_mth_in })) return 0;
  return s0_pv_fut_pols_if({ policy_term_in, duration_mth_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, t_in: s0_t({ t_in }) + 1 }) + s0_pv_pols_if({ duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in });
};
...
export const s0_duration$m = memoize(s0_duration$, ({duration_mth_in, t_in}) => Object.values(({duration_mth_in, t_in})).toString()); 
...
export const s0_lapse_rate$m = memoize(s0_lapse_rate$, ({duration_mth_in, t_in}) => Object.values(({duration_mth_in, t_in})).toString()); 
export const s0_lapse_rate = ({duration_mth_in, t_in}) => s0_lapse_rate$m({duration_mth_in, t_in})
...
export const s0_pols_if_at$m = memoize(s0_pols_if_at$, ({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pols_if_at = ({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pols_if_at$m({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pols_if_at'] = s0_pols_if_at

export const s0_pols_lapse$m = memoize(s0_pols_lapse$, ({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pols_lapse = ({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pols_lapse$m({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pols_lapse'] = s0_pols_lapse

export const s0_pols_maturity$m = memoize(s0_pols_maturity$, ({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pols_maturity = ({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pols_maturity$m({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pols_maturity'] = s0_pols_maturity

export const s0_pols_new_biz$m = memoize(s0_pols_new_biz$, ({duration_mth_in, t_in, policy_count_in}) => Object.values(({duration_mth_in, t_in, policy_count_in})).toString()); 
export const s0_pols_new_biz = ({duration_mth_in, t_in, policy_count_in}) => s0_pols_new_biz$m({duration_mth_in, t_in, policy_count_in})
model['s0_pols_new_biz'] = s0_pols_new_biz

export const s0_pols_death$m = memoize(s0_pols_death$, ({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pols_death = ({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pols_death$m({duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pols_death'] = s0_pols_death

export const s0_premium_pp$m = memoize(s0_premium_pp$, ({sum_assured_in, age_at_entry_in, policy_term_in}) => Object.values(({sum_assured_in, age_at_entry_in, policy_term_in})).toString()); 
export const s0_premium_pp = ({sum_assured_in, age_at_entry_in, policy_term_in}) => s0_premium_pp$m({sum_assured_in, age_at_entry_in, policy_term_in})
model['s0_premium_pp'] = s0_premium_pp

export const s0_expense_acq$m = memoize(s0_expense_acq$, ({}) => Object.values(({})).toString()); 
export const s0_expense_acq = ({}) => s0_expense_acq$m({})
model['s0_expense_acq'] = s0_expense_acq

export const s0_expense_maint$m = memoize(s0_expense_maint$, ({}) => Object.values(({})).toString()); 
export const s0_expense_maint = ({}) => s0_expense_maint$m({})
model['s0_expense_maint'] = s0_expense_maint

export const s0_inflation_rate$m = memoize(s0_inflation_rate$, ({}) => Object.values(({})).toString()); 
export const s0_inflation_rate = ({}) => s0_inflation_rate$m({})
model['s0_inflation_rate'] = s0_inflation_rate

export const s0_inflation_rate_mth$m = memoize(s0_inflation_rate_mth$, ({}) => Object.values(({})).toString()); 
export const s0_inflation_rate_mth = ({}) => s0_inflation_rate_mth$m({})
model['s0_inflation_rate_mth'] = s0_inflation_rate_mth

export const s0_inflation_factor$m = memoize(s0_inflation_factor$, ({t_in}) => Object.values(({t_in})).toString()); 
export const s0_inflation_factor = ({t_in}) => s0_inflation_factor$m({t_in})
model['s0_inflation_factor'] = s0_inflation_factor

export const s0_premiums$m = memoize(s0_premiums$, ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in}) => Object.values(({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in})).toString()); 
export const s0_premiums = ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in}) => s0_premiums$m({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in})
model['s0_premiums'] = s0_premiums

export const s0_claims$m = memoize(s0_claims$, ({sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_claims = ({sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_claims$m({sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_claims'] = s0_claims

export const s0_expenses$m = memoize(s0_expenses$, ({duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_expenses = ({duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in}) => s0_expenses$m({duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_expenses'] = s0_expenses

export const s0_commissions$m = memoize(s0_commissions$, ({duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in}) => Object.values(({duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in})).toString()); 
export const s0_commissions = ({duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in}) => s0_commissions$m({duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in})
model['s0_commissions'] = s0_commissions

export const s0_commission_mths$m = memoize(s0_commission_mths$, ({}) => Object.values(({})).toString()); 
export const s0_commission_mths = ({}) => s0_commission_mths$m({})
model['s0_commission_mths'] = s0_commission_mths

export const s0_commission_pc$m = memoize(s0_commission_pc$, ({}) => Object.values(({})).toString()); 
export const s0_commission_pc = ({}) => s0_commission_pc$m({})
model['s0_commission_pc'] = s0_commission_pc

export const s0_net_cf$m = memoize(s0_net_cf$, ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in}) => Object.values(({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in})).toString()); 
export const s0_net_cf = ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in}) => s0_net_cf$m({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in})
model['s0_net_cf'] = s0_net_cf

export const s0_proj_len$m = memoize(s0_proj_len$, ({policy_term_in, duration_mth_in}) => Object.values(({policy_term_in, duration_mth_in})).toString()); 
export const s0_proj_len = ({policy_term_in, duration_mth_in}) => s0_proj_len$m({policy_term_in, duration_mth_in})
model['s0_proj_len'] = s0_proj_len

export const s0_is_active$m = memoize(s0_is_active$, ({duration_mth_in, t_in, policy_term_in}) => Object.values(({duration_mth_in, t_in, policy_term_in})).toString()); 
export const s0_is_active = ({duration_mth_in, t_in, policy_term_in}) => s0_is_active$m({duration_mth_in, t_in, policy_term_in})
model['s0_is_active'] = s0_is_active

export const s0_pols_if$m = memoize(s0_pols_if$, ({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pols_if = ({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pols_if$m({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pols_if'] = s0_pols_if

export const s0_net_premium_pp$m = memoize(s0_net_premium_pp$, ({policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in}) => Object.values(({policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in})).toString()); 
export const s0_net_premium_pp = ({policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in}) => s0_net_premium_pp$m({policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in})
model['s0_net_premium_pp'] = s0_net_premium_pp

export const s0_premium_rate_per_mille$m = memoize(s0_premium_rate_per_mille$, ({age_at_entry_in, policy_term_in}) => Object.values(({age_at_entry_in, policy_term_in})).toString()); 
export const s0_premium_rate_per_mille = ({age_at_entry_in, policy_term_in}) => s0_premium_rate_per_mille$m({age_at_entry_in, policy_term_in})
model['s0_premium_rate_per_mille'] = s0_premium_rate_per_mille

export const s0_disc_rate_ann$m = memoize(s0_disc_rate_ann$, ({t_in}) => Object.values(({t_in})).toString()); 
export const s0_disc_rate_ann = ({t_in}) => s0_disc_rate_ann$m({t_in})
model['s0_disc_rate_ann'] = s0_disc_rate_ann

export const s0_disc_rate_mth$m = memoize(s0_disc_rate_mth$, ({t_in}) => Object.values(({t_in})).toString()); 
export const s0_disc_rate_mth = ({t_in}) => s0_disc_rate_mth$m({t_in})
model['s0_disc_rate_mth'] = s0_disc_rate_mth

export const s0_disc_factor$m = memoize(s0_disc_factor$, ({t_in}) => Object.values(({t_in})).toString()); 
export const s0_disc_factor = ({t_in}) => s0_disc_factor$m({t_in})
model['s0_disc_factor'] = s0_disc_factor

export const s0_pv_claims$m = memoize(s0_pv_claims$, ({sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pv_claims = ({sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pv_claims$m({sum_assured_in, duration_mth_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pv_claims'] = s0_pv_claims

export const s0_pv_premiums$m = memoize(s0_pv_premiums$, ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in}) => Object.values(({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in})).toString()); 
export const s0_pv_premiums = ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in}) => s0_pv_premiums$m({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in})
model['s0_pv_premiums'] = s0_pv_premiums

export const s0_pv_expenses$m = memoize(s0_pv_expenses$, ({duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pv_expenses = ({duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pv_expenses$m({duration_mth_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pv_expenses'] = s0_pv_expenses

export const s0_pv_commissions$m = memoize(s0_pv_commissions$, ({duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in}) => Object.values(({duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in})).toString()); 
export const s0_pv_commissions = ({duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in}) => s0_pv_commissions$m({duration_mth_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in})
model['s0_pv_commissions'] = s0_pv_commissions

export const s0_pv_net_cf$m = memoize(s0_pv_net_cf$, ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in}) => Object.values(({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in})).toString()); 
export const s0_pv_net_cf = ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in}) => s0_pv_net_cf$m({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_in, t_in, policy_count_in, zero_decrement_experience_in})
model['s0_pv_net_cf'] = s0_pv_net_cf

export const s0_pv_pols_if$m = memoize(s0_pv_pols_if$, ({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pv_pols_if = ({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pv_pols_if$m({duration_mth_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pv_pols_if'] = s0_pv_pols_if

export const s0_pv_fut_claims$m = memoize(s0_pv_fut_claims$, ({t_in, policy_term_in, duration_mth_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in})).toString()); 
export const s0_pv_fut_claims = ({t_in, policy_term_in, duration_mth_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in}) => s0_pv_fut_claims$m({t_in, policy_term_in, duration_mth_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in})
model['s0_pv_fut_claims'] = s0_pv_fut_claims

export const s0_pv_fut_premiums$m = memoize(s0_pv_fut_premiums$, ({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in})).toString()); 
export const s0_pv_fut_premiums = ({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in}) => s0_pv_fut_premiums$m({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in})
model['s0_pv_fut_premiums'] = s0_pv_fut_premiums

export const s0_pv_fut_expenses$m = memoize(s0_pv_fut_expenses$, ({t_in, policy_term_in, duration_mth_in, policy_count_in, timing_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_in, policy_count_in, timing_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in})).toString()); 
export const s0_pv_fut_expenses = ({t_in, policy_term_in, duration_mth_in, policy_count_in, timing_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in}) => s0_pv_fut_expenses$m({t_in, policy_term_in, duration_mth_in, policy_count_in, timing_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in})
model['s0_pv_fut_expenses'] = s0_pv_fut_expenses

export const s0_pv_fut_commissions$m = memoize(s0_pv_fut_commissions$, ({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in})).toString()); 
export const s0_pv_fut_commissions = ({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in}) => s0_pv_fut_commissions$m({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in})
model['s0_pv_fut_commissions'] = s0_pv_fut_commissions

export const s0_pv_fut_net_cf$m = memoize(s0_pv_fut_net_cf$, ({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in})).toString()); 
export const s0_pv_fut_net_cf = ({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in}) => s0_pv_fut_net_cf$m({t_in, policy_term_in, duration_mth_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in})
model['s0_pv_fut_net_cf'] = s0_pv_fut_net_cf

export const s0_pv_fut_pols_if$m = memoize(s0_pv_fut_pols_if$, ({t_in, policy_term_in, duration_mth_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in})).toString()); 
...
export const s1_premium_table$m = memoize(s1_premium_table$, ({}) => Object.values(({})).toString()); 
...
export const s1_disc_rate_ann_table$m = memoize(s1_disc_rate_ann_table$, ({}) => Object.values(({})).toString()); 
export const s1_disc_rate_ann_table = ({}) => s1_disc_rate_ann_table$m({})
...
export const mort_rate = s1_mort_rate; model['mort_rate'] = mort_rate; ;
...
export const t = s0_t; model['t'] = t;
export const age_at_entry = s0_age_at_entry; model['age_at_entry'] = age_at_entry;
export const sex = s0_sex; model['sex'] = sex;
export const policy_term = s0_policy_term; model['policy_term'] = policy_term;
export const policy_count = s0_policy_count; model['policy_count'] = policy_count;
export const sum_assured = s0_sum_assured; model['sum_assured'] = sum_assured;
export const duration_mth = s0_duration_mth; model['duration_mth'] = duration_mth;
export const duration_mth_0 = s0_duration_mth_0; model['duration_mth_0'] = duration_mth_0;
export const duration = s0_duration; model['duration'] = duration;
export const age = s0_age; model['age'] = age;
export const claim_pp = s0_claim_pp; model['claim_pp'] = claim_pp;
export const mort_rate_select_index = s0_mort_rate_select_index; model['mort_rate_select_index'] = mort_rate_select_index;
export const zero_decrement_experience = s0_zero_decrement_experience; model['zero_decrement_experience'] = zero_decrement_experience;
export const mort_rate_mth = s0_mort_rate_mth; model['mort_rate_mth'] = mort_rate_mth;
export const lapse_rate = s0_lapse_rate; model['lapse_rate'] = lapse_rate;
export const lapse_rate_mth = s0_lapse_rate_mth; model['lapse_rate_mth'] = lapse_rate_mth;
export const timing = s0_timing; model['timing'] = timing;
export const pols_if_init = s0_pols_if_init; model['pols_if_init'] = pols_if_init;
export const pols_if_at = s0_pols_if_at; model['pols_if_at'] = pols_if_at;
export const pols_lapse = s0_pols_lapse; model['pols_lapse'] = pols_lapse;
export const pols_maturity = s0_pols_maturity; model['pols_maturity'] = pols_maturity;
export const pols_new_biz = s0_pols_new_biz; model['pols_new_biz'] = pols_new_biz;
export const pols_death = s0_pols_death; model['pols_death'] = pols_death;
...
export const inflation_rate_mth = s0_inflation_rate_mth; model['inflation_rate_mth'] = inflation_rate_mth;
...
export const proj_len = s0_proj_len; model['proj_len'] = proj_len;
export const is_active = s0_is_active; model['is_active'] = is_active;
export const pols_if = s0_pols_if; model['pols_if'] = pols_if;
...
export const disc_rate_mth = s0_disc_rate_mth; model['disc_rate_mth'] = disc_rate_mth;
export const disc_factor = s0_disc_factor; model['disc_factor'] = disc_factor;
