...
export const s0_age$ = ({ age_at_entry_in, duration_mth_0_in, t_in }) => s0_age_at_entry({ age_at_entry_in }) + s0_duration({ duration_mth_0_in, t_in });
...
export const s0_mort_rate_select_index$ = ({ duration_mth_0_in, t_in }) =>
Math.max(0, Math.min(5, s0_duration({ duration_mth_0_in, t_in }))); // used to lookup mort_rate table

// I can hoist this change to playground.cul.js, but it provides context for pols_if_at behaviour here
export const s0_zero_decrement_experience$ = ({ zero_decrement_experience_in }) =>
zero_decrement_experience_in ?? true; // todo consider without this?

export const s0_mort_rate_mth$ = ({ t_in, zero_decrement_experience_in, age_at_entry_in, duration_mth_0_in }) => {
  if (s0_t({ t_in }) < 0 && s0_zero_decrement_experience({ zero_decrement_experience_in })) return 0;
  return 1 - (1 - s1_mort_rate({ age_at_entry_in, duration_mth_0_in, t_in })) ** (1 / 12);
};

// lapse rates
// tihs formula can get updated in the UI:
export const s0_lapse_rate$ = ({ duration_mth_0_in, t_in }) => Math.max(0.1 - 0.02 * s0_duration({ duration_mth_0_in, t_in }), 0.02);

export const s0_lapse_rate_mth$ = ({ t_in, zero_decrement_experience_in, duration_mth_0_in }) => {
  // factored from pols_lapse
  if (s0_t({ t_in }) < 0 && s0_zero_decrement_experience({ zero_decrement_experience_in })) return 0;
  return 1 - (1 - s0_lapse_rate({ duration_mth_0_in, t_in })) ** (1 / 12);
};
...
export const s0_pols_if_at$ = ({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => {
  if (s0_is_active({ duration_mth_0_in, t_in, policy_term_in }) == 0) return 0;
  if (s0_timing({ timing_in }) == "BEF_MAT") {
    ...
    return (
      s0_pols_if_at({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, t_in: s0_t({ t_in }) - 1, timing_in: "BEF_DECR" }) -
      s0_pols_lapse({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, t_in: s0_t({ t_in }) - 1 }) -
      s0_pols_death({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, t_in: s0_t({ t_in }) - 1 }));

  }
  if (s0_timing({ timing_in }) == "BEF_NB") {
    return s0_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: "BEF_MAT" }) - s0_pols_maturity({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in });
  }
  if (s0_timing({ timing_in }) == "BEF_DECR")
  return s0_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: "BEF_NB" }) + s0_pols_new_biz({ duration_mth_0_in, t_in, policy_count_in });
  return console.error("bad timing_in !");
};

export const s0_pols_lapse$ = ({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) =>
s0_is_active({ duration_mth_0_in, t_in, policy_term_in }) ?
(s0_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: "BEF_DECR" }) - s0_pols_death({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in })) * s0_lapse_rate_mth({ t_in, zero_decrement_experience_in, duration_mth_0_in }) :
0;

// refactor for stress and experience logic

export const s0_pols_maturity$ = ({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => {
  if (s0_duration_mth({ duration_mth_0_in, t_in }) == s0_policy_term({ policy_term_in }) * 12)
  return s0_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: "BEF_MAT" });else
  return 0;
};

export const s0_pols_new_biz$ = ({ duration_mth_0_in, t_in, policy_count_in }) => {
  if (s0_duration_mth({ duration_mth_0_in, t_in }) == 0) return s0_policy_count({ policy_count_in });else
  return 0;
};

export const s0_pols_death$ = ({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) =>
s0_is_active({ duration_mth_0_in, t_in, policy_term_in }) ? s0_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: "BEF_DECR" }) * s0_mort_rate_mth({ t_in, zero_decrement_experience_in, age_at_entry_in, duration_mth_0_in }) : 0;

// monthly
export const s0_premium_pp$ = ({ sum_assured_in, age_at_entry_in, policy_term_in }) =>
Math.round(s0_sum_assured({ sum_assured_in }) / 1000 * s0_premium_rate_per_mille({ age_at_entry_in, policy_term_in }) * 100) / 100; // round 2 decimal places
...
export const s0_premiums$ = ({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in }) =>
s0_premium_pp({ sum_assured_in, age_at_entry_in, policy_term_in }) * s0_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, timing_in: "BEF_DECR" });
...
export const s0_expenses_maint$ = ({ t_in, duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) =>
s0_expense_maint({}) / 12 *
...
export const s0_net_cf$ = ({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in }) => s0_premiums({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in }) + s0_claims({ sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) + s0_expenses({ duration_mth_0_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in }) + s0_commissions({ duration_mth_0_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in });

export const s0_proj_len$ = ({ policy_term_in, duration_mth_0_in }) =>
Math.max(12 * s0_policy_term({ policy_term_in }) - s0_duration_mth({ duration_mth_0_in, t_in: 0 }) + 1, 0);

// todo think re actuals (new)
export const s0_is_active$ = ({ duration_mth_0_in, t_in, policy_term_in }) =>
!(s0_duration_mth({ duration_mth_0_in, t_in }) < 0 || s0_duration_mth({ duration_mth_0_in, t_in }) > s0_policy_term({ policy_term_in }) * 12);

export const s0_pols_if$ = ({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) => s0_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in }) /*{ timing_in: 'BEF_MAT' }*/;
...
export const s0_net_premium_pp$ = ({ policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in }) => {
  return (
    -s0_pv_fut_claims({ policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, t_in: 0, duration_mth_0_in: 0 }) /
    s0_pv_fut_pols_if({ policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, t_in: 0, duration_mth_0_in: 0 }));

};

export const s0_premium_rate_per_mille$ = ({ age_at_entry_in, policy_term_in }) => s1_premium_rate({ age_at_entry_in, policy_term_in }) * 1000; // uses table from basicterm-tables.cul.js
...
export const s0_pv_fut_claims$ = ({ t_in, policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in }) => {
  if (s0_t({ t_in }) >= s0_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s0_pv_fut_claims({ policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, t_in: s0_t({ t_in }) + 1 }) + s0_pv_claims({ sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in });
};

export const s0_pv_fut_premiums$ = ({ t_in, policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in }) => {
  if (s0_t({ t_in }) >= s0_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s0_pv_fut_premiums({ policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in, t_in: s0_t({ t_in }) + 1 }) + s0_pv_premiums({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in });
};
...
export const s0_pv_fut_commissions$ = ({ t_in, policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in }) => {
  if (s0_t({ t_in }) >= s0_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s0_pv_fut_commissions({ policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in, t_in: s0_t({ t_in }) + 1 }) + s0_pv_commissions({ duration_mth_0_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in });
};

export const s0_pv_fut_net_cf$ = ({ t_in, policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in }) => {
  if (s0_t({ t_in }) >= s0_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s0_pv_fut_net_cf({ policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in, t_in: s0_t({ t_in }) + 1 }) + s0_pv_net_cf({ sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in });
};

export const s0_pv_fut_pols_if$ = ({ t_in, policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in }) => {
  if (s0_t({ t_in }) >= s0_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s0_pv_fut_pols_if({ policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, t_in: s0_t({ t_in }) + 1 }) + s0_pv_pols_if({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in });
};
...
s1_premium_table({}).find(
  (d) => d.age_at_entry == s0_age_at_entry({ age_at_entry_in }) && d.policy_term == s0_policy_term({ policy_term_in })
).premium_rate;

export const s1_premium_table$ = ({}) =>
JSON.parse(
...
export const s1_mort_rate$ = ({ age_at_entry_in, duration_mth_0_in, t_in }) =>
s1_mort_table({}).find((d) => d.Age == s0_age({ age_at_entry_in, duration_mth_0_in, t_in }))[s0_mort_rate_select_index({ duration_mth_0_in, t_in })];

export const s1_mort_table$ = ({}) =>
JSON.parse(
...
export const s1_zero_spot$ = ({ zero_spot_year_in }) =>
s1_disc_rate_ann_table({})[s1_zero_spot_year({ zero_spot_year_in })]?.zero_spot ?? 0;

export const s1_disc_rate_ann_table$ = ({}) =>
JSON.parse(
...
export const s0_duration_mth$m = memoize(s0_duration_mth$, ({duration_mth_0_in, t_in}) => Object.values(({duration_mth_0_in, t_in})).toString()); 
export const s0_duration_mth = ({duration_mth_0_in, t_in}) => s0_duration_mth$m({duration_mth_0_in, t_in})
model['s0_duration_mth'] = s0_duration_mth

export const s0_duration_mth_0$m = memoize(s0_duration_mth_0$, ({duration_mth_0_in}) => Object.values(({duration_mth_0_in})).toString()); 
export const s0_duration_mth_0 = ({duration_mth_0_in}) => s0_duration_mth_0$m({duration_mth_0_in})
model['s0_duration_mth_0'] = s0_duration_mth_0

export const s0_duration$m = memoize(s0_duration$, ({duration_mth_0_in, t_in}) => Object.values(({duration_mth_0_in, t_in})).toString()); 
export const s0_duration = ({duration_mth_0_in, t_in}) => s0_duration$m({duration_mth_0_in, t_in})
model['s0_duration'] = s0_duration

export const s0_age$m = memoize(s0_age$, ({age_at_entry_in, duration_mth_0_in, t_in}) => Object.values(({age_at_entry_in, duration_mth_0_in, t_in})).toString()); 
export const s0_age = ({age_at_entry_in, duration_mth_0_in, t_in}) => s0_age$m({age_at_entry_in, duration_mth_0_in, t_in})
model['s0_age'] = s0_age
...
export const s0_mort_rate_select_index$m = memoize(s0_mort_rate_select_index$, ({duration_mth_0_in, t_in}) => Object.values(({duration_mth_0_in, t_in})).toString()); 
export const s0_mort_rate_select_index = ({duration_mth_0_in, t_in}) => s0_mort_rate_select_index$m({duration_mth_0_in, t_in})
...
export const s0_mort_rate_mth$m = memoize(s0_mort_rate_mth$, ({t_in, zero_decrement_experience_in, age_at_entry_in, duration_mth_0_in}) => Object.values(({t_in, zero_decrement_experience_in, age_at_entry_in, duration_mth_0_in})).toString()); 
export const s0_mort_rate_mth = ({t_in, zero_decrement_experience_in, age_at_entry_in, duration_mth_0_in}) => s0_mort_rate_mth$m({t_in, zero_decrement_experience_in, age_at_entry_in, duration_mth_0_in})
model['s0_mort_rate_mth'] = s0_mort_rate_mth

export const s0_lapse_rate$m = memoize(s0_lapse_rate$, ({duration_mth_0_in, t_in}) => Object.values(({duration_mth_0_in, t_in})).toString()); 
export const s0_lapse_rate = ({duration_mth_0_in, t_in}) => s0_lapse_rate$m({duration_mth_0_in, t_in})
model['s0_lapse_rate'] = s0_lapse_rate

export const s0_lapse_rate_mth$m = memoize(s0_lapse_rate_mth$, ({t_in, zero_decrement_experience_in, duration_mth_0_in}) => Object.values(({t_in, zero_decrement_experience_in, duration_mth_0_in})).toString()); 
export const s0_lapse_rate_mth = ({t_in, zero_decrement_experience_in, duration_mth_0_in}) => s0_lapse_rate_mth$m({t_in, zero_decrement_experience_in, duration_mth_0_in})
...
export const s0_pols_if_at$m = memoize(s0_pols_if_at$, ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pols_if_at = ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pols_if_at$m({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pols_if_at'] = s0_pols_if_at

export const s0_pols_lapse$m = memoize(s0_pols_lapse$, ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pols_lapse = ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pols_lapse$m({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pols_lapse'] = s0_pols_lapse

export const s0_pols_maturity$m = memoize(s0_pols_maturity$, ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pols_maturity = ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pols_maturity$m({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pols_maturity'] = s0_pols_maturity

export const s0_pols_new_biz$m = memoize(s0_pols_new_biz$, ({duration_mth_0_in, t_in, policy_count_in}) => Object.values(({duration_mth_0_in, t_in, policy_count_in})).toString()); 
export const s0_pols_new_biz = ({duration_mth_0_in, t_in, policy_count_in}) => s0_pols_new_biz$m({duration_mth_0_in, t_in, policy_count_in})
model['s0_pols_new_biz'] = s0_pols_new_biz

export const s0_pols_death$m = memoize(s0_pols_death$, ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pols_death = ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pols_death$m({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
...
export const s0_premiums$m = memoize(s0_premiums$, ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in}) => Object.values(({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in})).toString()); 
export const s0_premiums = ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in}) => s0_premiums$m({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in})
model['s0_premiums'] = s0_premiums

export const s0_claims$m = memoize(s0_claims$, ({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
...
export const s0_commissions$m = memoize(s0_commissions$, ({duration_mth_0_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in}) => Object.values(({duration_mth_0_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in})).toString()); 
export const s0_commissions = ({duration_mth_0_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in}) => s0_commissions$m({duration_mth_0_in, t_in, sum_assured_in, age_at_entry_in, policy_term_in, policy_count_in, zero_decrement_experience_in})
...
export const s0_net_cf$m = memoize(s0_net_cf$, ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in}) => Object.values(({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in})).toString()); 
export const s0_net_cf = ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in}) => s0_net_cf$m({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in})
model['s0_net_cf'] = s0_net_cf

export const s0_proj_len$m = memoize(s0_proj_len$, ({policy_term_in, duration_mth_0_in}) => Object.values(({policy_term_in, duration_mth_0_in})).toString()); 
export const s0_proj_len = ({policy_term_in, duration_mth_0_in}) => s0_proj_len$m({policy_term_in, duration_mth_0_in})
model['s0_proj_len'] = s0_proj_len

export const s0_is_active$m = memoize(s0_is_active$, ({duration_mth_0_in, t_in, policy_term_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in})).toString()); 
export const s0_is_active = ({duration_mth_0_in, t_in, policy_term_in}) => s0_is_active$m({duration_mth_0_in, t_in, policy_term_in})
model['s0_is_active'] = s0_is_active

export const s0_pols_if$m = memoize(s0_pols_if$, ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pols_if = ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pols_if$m({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
...
export const s0_pv_claims$m = memoize(s0_pv_claims$, ({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pv_claims = ({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pv_claims$m({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pv_claims'] = s0_pv_claims

export const s0_pv_premiums$m = memoize(s0_pv_premiums$, ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in}) => Object.values(({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in})).toString()); 
export const s0_pv_premiums = ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in}) => s0_pv_premiums$m({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in})
model['s0_pv_premiums'] = s0_pv_premiums

export const s0_pv_expenses$m = memoize(s0_pv_expenses$, ({duration_mth_0_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_0_in, t_in, policy_count_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
...
export const s0_pv_net_cf$m = memoize(s0_pv_net_cf$, ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in}) => Object.values(({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in})).toString()); 
export const s0_pv_net_cf = ({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in}) => s0_pv_net_cf$m({sum_assured_in, age_at_entry_in, policy_term_in, duration_mth_0_in, t_in, policy_count_in, zero_decrement_experience_in})
model['s0_pv_net_cf'] = s0_pv_net_cf

export const s0_pv_pols_if$m = memoize(s0_pv_pols_if$, ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})).toString()); 
export const s0_pv_pols_if = ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in}) => s0_pv_pols_if$m({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in})
model['s0_pv_pols_if'] = s0_pv_pols_if

export const s0_pv_fut_claims$m = memoize(s0_pv_fut_claims$, ({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in})).toString()); 
export const s0_pv_fut_claims = ({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in}) => s0_pv_fut_claims$m({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in})
model['s0_pv_fut_claims'] = s0_pv_fut_claims

export const s0_pv_fut_premiums$m = memoize(s0_pv_fut_premiums$, ({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in})).toString()); 
export const s0_pv_fut_premiums = ({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in}) => s0_pv_fut_premiums$m({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in})
...
export const s0_pv_fut_net_cf$m = memoize(s0_pv_fut_net_cf$, ({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in})).toString()); 
export const s0_pv_fut_net_cf = ({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in}) => s0_pv_fut_net_cf$m({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, age_at_entry_in, timing_in, policy_count_in, zero_decrement_experience_in, zero_spot_year_in})
model['s0_pv_fut_net_cf'] = s0_pv_fut_net_cf

export const s0_pv_fut_pols_if$m = memoize(s0_pv_fut_pols_if$, ({t_in, policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in})).toString()); 
export const s0_pv_fut_pols_if = ({t_in, policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in}) => s0_pv_fut_pols_if$m({t_in, policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in})
...
export const s1_mort_rate$m = memoize(s1_mort_rate$, ({age_at_entry_in, duration_mth_0_in, t_in}) => Object.values(({age_at_entry_in, duration_mth_0_in, t_in})).toString()); 
export const s1_mort_rate = ({age_at_entry_in, duration_mth_0_in, t_in}) => s1_mort_rate$m({age_at_entry_in, duration_mth_0_in, t_in})
