...
export const s1_premium_pp_$m = memoize(s1_premium_pp_$, ({sum_assured_in, loading_prem_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, zero_spot_year_in, premium_payment_frequency_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => Object.values(({sum_assured_in, loading_prem_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, zero_spot_year_in, premium_payment_frequency_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})).toString()); 
export const s1_premium_pp_ = ({sum_assured_in, loading_prem_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, zero_spot_year_in, premium_payment_frequency_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => s1_premium_pp_$m({sum_assured_in, loading_prem_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, zero_spot_year_in, premium_payment_frequency_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})
