...
export const s0_lapse_rate$ = ({ t_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in }) => {
  if (s1_t({ t_in }) < s0_stress_delay({ stress_delay_in })) return s0_original_lapse_rates({ original_lapse_rates_in }) ? Math.max(0.1 - 0.02 * s1_duration({ duration_mth_0_in, t_in }), 0.02) : s1_lapse_rate_({ duration_mth_0_in, t_in });else
  return s0_lapse_rate_factor({ lapse_rate_factor_in }) * (s0_original_lapse_rates({ original_lapse_rates_in }) ? Math.max(0.1 - 0.02 * s1_duration({ duration_mth_0_in, t_in }), 0.02) : s1_lapse_rate_({ duration_mth_0_in, t_in }));
};
...
export const s0_premium_due$ = ({ premium_payment_frequency_in, t_in, duration_mth_0_in }) => {
  ...
  return s1_t({ t_in }) == -s1_duration_mth_0({ duration_mth_0_in });
...
export const s0_mort_rate_recalc$ = ({ age_at_entry_in, duration_mth_0_in, t_in, sex_in }) => Math.min(1, Math.min(1, s0_a({}) * Math.exp(s0_b({}) * Math.pow(s1_age({ age_at_entry_in, duration_mth_0_in, t_in }), s0_c({})))) * Math.pow(1.1, s1_mort_rate_select_index({ duration_mth_0_in, t_in })) * (s1_sex({ sex_in }) == 'M' ? 1.2 : 1));
...
export const s0_status$ = ({ duration_mth_0_in }) => s1_duration_mth_0({ duration_mth_0_in }) == 0 ? 'New Business' : 'In Force';
...
export const s1_mort_rate_select_index$ = ({ duration_mth_0_in, t_in }) => Math.max(0, Math.min(5, s1_duration({ duration_mth_0_in, t_in }))); // used to lookup mort_rate table
...
export const s1_lapse_rate_mth$ = ({ t_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in }) => {// factored from pols_lapse
  if (s1_t({ t_in }) < 0 && s1_zero_decrement_experience({ zero_decrement_experience_in })) return 0;
...
export const s1_pols_if_at$ = ({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) => {
  ...
  if (s1_timing({ timing_in }) == 'BEF_MAT') {
    ...
    return s1_pols_if_at({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, t_in: s1_t({ t_in }) - 1, timing_in: 'BEF_DECR' }) - s1_pols_lapse({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, t_in: s1_t({ t_in }) - 1 }) - s1_pols_death({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, t_in: s1_t({ t_in }) - 1 });
  }
...
export const s1_expenses_maint$ = ({ t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) => s0_expense_maint({ t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in }) / 12 * s1_inflation_factor({ t_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in }) * s1_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, timing_in: 'BEF_DECR' }); // monthly maintenance expenses, inflated
...
export const s1_proj_len$ = ({ policy_term_in, duration_mth_0_in }) => Math.max(12 * s1_policy_term({ policy_term_in }) - s1_duration_mth({ duration_mth_0_in, t_in: 0 }) + 1, 0);

// todo think re actuals (new)
export const s1_is_active$ = ({ duration_mth_0_in, t_in, policy_term_in }) => !(s1_duration_mth({ duration_mth_0_in, t_in }) < 0 || s1_duration_mth({ duration_mth_0_in, t_in }) > s1_policy_term({ policy_term_in }) * 12);
