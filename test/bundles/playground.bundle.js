...
export const s0_expense_acq$ = ({ expense_acq_in }) => expense_acq_in ?? 300;
...
export const s0_lapse_rate$ = ({ t_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in }) => {
  if (s1_t({ t_in }) < s0_stress_delay({ stress_delay_in }))
  return s0_original_lapse_rates({ original_lapse_rates_in }) ?
  Math.max(0.1 - 0.02 * s1_duration({ duration_mth_0_in, t_in }), 0.02) :
  s1_lapse_rate_({ duration_mth_0_in, t_in });else

  return (
    s0_lapse_rate_factor({ lapse_rate_factor_in }) * (
    s0_original_lapse_rates({ original_lapse_rates_in }) ?
    Math.max(0.1 - 0.02 * s1_duration({ duration_mth_0_in, t_in }), 0.02) :
    s1_lapse_rate_({ duration_mth_0_in, t_in })));
...
export const s0_mort_rate_Y1_add_per_mille$ = ({ mort_rate_Y1_add_per_mille_in }) =>
mort_rate_Y1_add_per_mille_in ?? 0;

export const s0_mort_rate_addition$ = ({ t_in, stress_delay_in, mort_rate_Y1_add_per_mille_in }) => {
  if (s1_t({ t_in }) < 12 + s0_stress_delay({ stress_delay_in })) return s0_mort_rate_Y1_add_per_mille({ mort_rate_Y1_add_per_mille_in }) / 1000;else
  return 0;
};
...
export const s0_inflation_factor$ = ({ t_in, duration_mth_0_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in }) => {
  if (s1_t({ t_in }) < -s1_duration_mth_0({ duration_mth_0_in })) return s0_inflation_factor({ duration_mth_0_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in, t_in: s1_t({ t_in }) + 1 }) / (1 + s1_inflation_rate_mth({ t_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in }));
  if (s1_t({ t_in }) == -s1_duration_mth_0({ duration_mth_0_in })) return 1;else
  return s0_inflation_factor({ duration_mth_0_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in, t_in: s1_t({ t_in }) - 1 }) * (1 + s1_inflation_rate_mth({ t_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in }));
};
...
export const s0_update_pricing_lapse_rates$ = ({ update_pricing_lapse_rates_in }) =>
update_pricing_lapse_rates_in ?? false;
...
export const s0_net_premium_pp$ = ({ pricing_projection_in, policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) => {
  ...
  return s1_net_premium_pp_({ policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, zero_spot_year_in, premium_payment_frequency_in,
    /* 1000e sum assured projection with pricing config and no stresses, and discounting always on */sum_assured_in: 1000,
    original_lapse_rates_in: !s0_update_pricing_lapse_rates({ update_pricing_lapse_rates_in }),
    discounting_on_in: true,
    sex_in: s0_gender_neutral_pricing({ gender_neutral_pricing_in }) ? "F" : s1_sex({ sex_in }),
    timing_in: "BEF_DECR",
    stress_delay_in: 12 * 120,
    lapse_rate_factor_in: 1,
    mort_rate_factor_in: 1,
    mort_rate_Y1_add_per_mille_in: 0 }
  );else
...
(1 + s0_loading_prem({ loading_prem_in })) * s0_net_premium_pp({ policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, pricing_projection_in: true });

export const s0_pv_pols_if$ = ({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, premium_payment_frequency_in }) => s1_pv_pols_if_({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in }) * s0_premium_due({ premium_payment_frequency_in, t_in, duration_mth_0_in }); // used by net_premium_pp via pv_fut_pols_if

// DIFFERENT PREMIUM FREQUENCIES

export const s0_premium_payment_frequency$ = ({ premium_payment_frequency_in }) =>
premium_payment_frequency_in ?? "M"; // or "single"
...
export const s0_premium_due$ = ({ premium_payment_frequency_in, t_in, duration_mth_0_in }) => {
  if (s0_premium_payment_frequency({ premium_payment_frequency_in }) == "single") return s1_t({ t_in }) == -s1_duration_mth_0({ duration_mth_0_in });
  if (s1_duration({ duration_mth_0_in, t_in }) != s1_duration({ duration_mth_0_in, t_in: s1_t({ t_in }) - 1 })) return 1;
  if (s1_duration_mth({ duration_mth_0_in, t_in }) % s0_premium_period({ premium_payment_frequency_in }) == 0) return 1;else
  return 0;
};

// NOT annualized
export const s0_premium_pp$ = ({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) => {
  if (!s0_premium_due({ premium_payment_frequency_in, t_in, duration_mth_0_in })) return 0;
...
export const s0_mort_rate_recalc$ = ({ age_at_entry_in, duration_mth_0_in, t_in, sex_in }) =>
Math.min(
  1,
  Math.min(1, s0_a({}) * Math.exp(s0_b({}) * Math.pow(s1_age({ age_at_entry_in, duration_mth_0_in, t_in }), s0_c({})))) *
  Math.pow(1.1, s1_mort_rate_select_index({ duration_mth_0_in, t_in })) * (
  s1_sex({ sex_in }) == "M" ? 1.2 : 1)
);

export const s0_mort_rate$ = ({ t_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in }) => {
  if (s1_t({ t_in }) < s0_stress_delay({ stress_delay_in })) return s0_mort_rate_recalc({ age_at_entry_in, duration_mth_0_in, t_in, sex_in });else
  return s0_mort_rate_recalc({ age_at_entry_in, duration_mth_0_in, t_in, sex_in }) * s0_mort_rate_factor({ mort_rate_factor_in }) + s0_mort_rate_addition({ t_in, stress_delay_in, mort_rate_Y1_add_per_mille_in }); // note: added after factor on overall assumption
};
...
export const s0_premium_pp_0$ = ({ premium_payment_frequency_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) => s0_premium_pp({ premium_payment_frequency_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, t_in: -s1_duration_mth_0({ duration_mth_0_in }) }); // to show the premium
export const s0_status$ = ({ duration_mth_0_in }) =>
s1_duration_mth_0({ duration_mth_0_in }) == 0 ? "New Business" : "In Force";
...
export const s0_net_cf$ = ({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in }) => s1_net_cf_({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in }) + s0_placeholder({}) + s0_placeholder2({});
...
export const s0_policy_value$ = ({ policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in }) => s1_pv_fut_net_cf({ policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in, t_in: 0 });
...
export const s1_t$ = ({ t_in }) => t_in ?? 0;

// 'model point' inputs
export const s1_age_at_entry$ = ({ age_at_entry_in }) => age_at_entry_in ?? 20;
export const s1_sex$ = ({ sex_in }) => sex_in ?? "M";
export const s1_policy_term$ = ({ policy_term_in }) => policy_term_in ?? 10;
export const s1_policy_count$ = ({ policy_count_in }) => policy_count_in ?? 1;
export const s1_sum_assured$ = ({ sum_assured_in }) => sum_assured_in ?? 100000;
...
export const s1_duration_mth$ = ({ duration_mth_0_in, t_in }) => s1_duration_mth_0({ duration_mth_0_in }) + s1_t({ t_in });

// duration "now" since policy started:
export const s1_duration_mth_0$ = ({ duration_mth_0_in }) => duration_mth_0_in ?? 0;

// duration since policy started, in years:
export const s1_duration$ = ({ duration_mth_0_in, t_in }) => Math.floor(s1_duration_mth({ duration_mth_0_in, t_in }) / 12);

export const s1_age$ = ({ age_at_entry_in, duration_mth_0_in, t_in }) => s1_age_at_entry({ age_at_entry_in }) + s1_duration({ duration_mth_0_in, t_in });
...
export const s1_mort_rate_select_index$ = ({ duration_mth_0_in, t_in }) =>
Math.max(0, Math.min(5, s1_duration({ duration_mth_0_in, t_in }))); // used to lookup mort_rate table

// I can hoist this change to playground.cul.js, but it provides context for pols_if_at behaviour here
export const s1_zero_decrement_experience$ = ({ zero_decrement_experience_in }) =>
zero_decrement_experience_in ?? true; // todo consider without this?

export const s1_mort_rate_mth$ = ({ t_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in }) => {
  if (s1_t({ t_in }) < 0 && s1_zero_decrement_experience({ zero_decrement_experience_in })) return 0;
  return 1 - (1 - s0_mort_rate({ t_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in })) ** (1 / 12);
};

// lapse rates
// tihs formula can get updated in the UI:
export const s1_lapse_rate_$ = ({ duration_mth_0_in, t_in }) => Math.max(0.1 - 0.02 * s1_duration({ duration_mth_0_in, t_in }), 0.02);

export const s1_lapse_rate_mth$ = ({ t_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in }) => {
  // factored from pols_lapse
  if (s1_t({ t_in }) < 0 && s1_zero_decrement_experience({ zero_decrement_experience_in })) return 0;
  return 1 - (1 - s0_lapse_rate({ t_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in })) ** (1 / 12);
};

// policy survival/decrement projections

export const s1_timing$ = ({ timing_in }) => timing_in ?? "BEF_NB";
...
export const s1_pols_if_at$ = ({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) => {
  if (s1_is_active({ duration_mth_0_in, t_in, policy_term_in }) == 0) return 0;
  if (s1_timing({ timing_in }) == "BEF_MAT") {
    ...
    return (
      s1_pols_if_at({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, t_in: s1_t({ t_in }) - 1, timing_in: "BEF_DECR" }) -
      s1_pols_lapse({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, t_in: s1_t({ t_in }) - 1 }) -
      s1_pols_death({ duration_mth_0_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, t_in: s1_t({ t_in }) - 1 }));

  }
  if (s1_timing({ timing_in }) == "BEF_NB") {
    return s1_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, timing_in: "BEF_MAT" }) - s1_pols_maturity({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in });
  }
  if (s1_timing({ timing_in }) == "BEF_DECR")
  return s1_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, timing_in: "BEF_NB" }) + s1_pols_new_biz({ duration_mth_0_in, t_in, policy_count_in });
  return console.error("bad timing_in !");
};

export const s1_pols_lapse$ = ({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) =>
s1_is_active({ duration_mth_0_in, t_in, policy_term_in }) ?
(s1_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, timing_in: "BEF_DECR" }) - s1_pols_death({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in })) * s1_lapse_rate_mth({ t_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in }) :
0;

// refactor for stress and experience logic

export const s1_pols_maturity$ = ({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) => {
  if (s1_duration_mth({ duration_mth_0_in, t_in }) == s1_policy_term({ policy_term_in }) * 12)
  return s1_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, timing_in: "BEF_MAT" });else
  return 0;
};

export const s1_pols_new_biz$ = ({ duration_mth_0_in, t_in, policy_count_in }) => {
  if (s1_duration_mth({ duration_mth_0_in, t_in }) == 0) return s1_policy_count({ policy_count_in });else
  return 0;
};

export const s1_pols_death$ = ({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in }) =>
s1_is_active({ duration_mth_0_in, t_in, policy_term_in }) ? s1_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, timing_in: "BEF_DECR" }) * s1_mort_rate_mth({ t_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in }) : 0;

// monthly
export const s1_premium_pp_$ = ({ sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) =>
Math.round(s1_sum_assured({ sum_assured_in }) / 1000 * s0_premium_rate_per_mille({ loading_prem_in, policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) * 100) / 100; // round 2 decimal places
...
export const s1_premiums$ = ({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) =>
s0_premium_pp({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) * s1_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, timing_in: "BEF_DECR" });
export const s1_claims$ = ({ sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in }) => -s1_claim_pp({ sum_assured_in }) * s1_pols_death({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in });
...
export const s1_expenses_acq$ = ({ expense_acq_in, duration_mth_0_in, t_in, policy_count_in }) => s0_expense_acq({ expense_acq_in }) * s1_pols_new_biz({ duration_mth_0_in, t_in, policy_count_in });
export const s1_expenses_maint$ = ({ t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) =>
s0_expense_maint({ t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in }) / 12 *
s0_inflation_factor({ t_in, duration_mth_0_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in }) *
s1_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, timing_in: "BEF_DECR" }); // monthly maintenance expenses, inflated

export const s1_expenses$ = ({ expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) => -(s1_expenses_acq({ expense_acq_in, duration_mth_0_in, t_in, policy_count_in }) + s1_expenses_maint({ t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }));

export const s1_commissions$ = ({ duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in }) =>
s1_duration_mth({ duration_mth_0_in, t_in }) < s0_commission_mths({ commission_mths_in }) ?
-s1_premiums({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) * s0_commission_pc({ commission_pc_in }) / 100 :
0;
...
// careful: manipulation in net_cf not captured in Playground outputs!
export const s1_net_cf_$ = ({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in }) => s1_premiums({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) + s1_claims({ sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in }) + s1_expenses({ expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) + s1_commissions({ duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in });

export const s1_proj_len$ = ({ policy_term_in, duration_mth_0_in }) =>
Math.max(12 * s1_policy_term({ policy_term_in }) - s1_duration_mth({ duration_mth_0_in, t_in: 0 }) + 1, 0);

// todo think re actuals (new)
export const s1_is_active$ = ({ duration_mth_0_in, t_in, policy_term_in }) =>
!(s1_duration_mth({ duration_mth_0_in, t_in }) < 0 || s1_duration_mth({ duration_mth_0_in, t_in }) > s1_policy_term({ policy_term_in }) * 12);

export const s1_pols_if$ = ({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) => s1_pols_if_at({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) /*{ timing_in: 'BEF_MAT' }*/;
...
export const s1_net_premium_pp_$ = ({ policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in }) => {
  return (
    -s1_pv_fut_claims({ policy_term_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, t_in: 0, duration_mth_0_in: 0 }) /
    s1_pv_fut_pols_if({ policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in, t_in: 0, duration_mth_0_in: 0 }));

};

export const s1_premium_rate_per_mille_$ = ({ age_at_entry_in, policy_term_in }) => s2_premium_rate({ age_at_entry_in, policy_term_in }) * 1000; // uses table from basicterm-tables.cul.js
...
export const s1_pv_claims$ = ({ sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in }) => s1_claims({ sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in }) * s1_disc_factor({ discounting_on_in, t_in });
export const s1_pv_premiums$ = ({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) => s1_premiums({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) * s1_disc_factor({ discounting_on_in, t_in });
export const s1_pv_expenses$ = ({ expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in }) => s1_expenses({ expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) * s1_disc_factor({ discounting_on_in, t_in });
export const s1_pv_expenses_maint$ = ({ t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in }) => s1_expenses_maint({ t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) * s1_disc_factor({ discounting_on_in, t_in });
export const s1_pv_expenses_acq$ = ({ expense_acq_in, duration_mth_0_in, t_in, policy_count_in, discounting_on_in }) => s1_expenses_acq({ expense_acq_in, duration_mth_0_in, t_in, policy_count_in }) * s1_disc_factor({ discounting_on_in, t_in });
export const s1_pv_commissions$ = ({ duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in }) => s1_commissions({ duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in }) * s1_disc_factor({ discounting_on_in, t_in });
export const s1_pv_net_cf$ = ({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in }) => s0_net_cf({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in }) * s1_disc_factor({ discounting_on_in, t_in });
export const s1_pv_pols_if_$ = ({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in }) => s1_pols_if({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in }) * s1_disc_factor({ discounting_on_in, t_in }); // BasicTerm_M, for pricing table calc reconciliation

// 2. pv_fut_x is sum of future present values >= t:
export const s1_pv_fut_claims$ = ({ t_in, policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in }) => {
  if (s1_t({ t_in }) >= s1_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s1_pv_fut_claims({ policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, t_in: s1_t({ t_in }) + 1 }) + s1_pv_claims({ sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in });
};

export const s1_pv_fut_premiums$ = ({ t_in, policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in }) => {
  if (s1_t({ t_in }) >= s1_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s1_pv_fut_premiums({ policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, t_in: s1_t({ t_in }) + 1 }) + s1_pv_premiums({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in });
};

export const s1_pv_fut_expenses$ = ({ t_in, policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in }) => {
  if (s1_t({ t_in }) >= s1_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s1_pv_fut_expenses({ policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in, t_in: s1_t({ t_in }) + 1 }) + s1_pv_expenses({ expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in });
};

export const s1_pv_fut_expenses_maint$ = ({ t_in, policy_term_in, duration_mth_0_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in }) => {
  if (s1_t({ t_in }) >= s1_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s1_pv_fut_expenses_maint({ policy_term_in, duration_mth_0_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in, t_in: s1_t({ t_in }) + 1 }) + s1_pv_expenses_maint({ t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in });
};

export const s1_pv_fut_expenses_acq$ = ({ t_in, policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, discounting_on_in, zero_spot_year_in }) => {
  if (s1_t({ t_in }) >= s1_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s1_pv_fut_expenses_acq({ policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, discounting_on_in, zero_spot_year_in, t_in: s1_t({ t_in }) + 1 }) + s1_pv_expenses_acq({ expense_acq_in, duration_mth_0_in, t_in, policy_count_in, discounting_on_in });
};

export const s1_pv_fut_commissions$ = ({ t_in, policy_term_in, duration_mth_0_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in }) => {
  if (s1_t({ t_in }) >= s1_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s1_pv_fut_commissions({ policy_term_in, duration_mth_0_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in, t_in: s1_t({ t_in }) + 1 }) + s1_pv_commissions({ duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in });
};

export const s1_pv_fut_net_cf$ = ({ t_in, policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in }) => {
  if (s1_t({ t_in }) >= s1_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s1_pv_fut_net_cf({ policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in, t_in: s1_t({ t_in }) + 1 }) + s1_pv_net_cf({ premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in });
};

export const s1_pv_fut_pols_if$ = ({ t_in, policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in }) => {
  if (s1_t({ t_in }) >= s1_proj_len({ policy_term_in, duration_mth_0_in })) return 0;
  return s1_pv_fut_pols_if({ policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in, t_in: s1_t({ t_in }) + 1 }) + s0_pv_pols_if({ duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, premium_payment_frequency_in });
};
...
export const s0_expense_acq$m = memoize(s0_expense_acq$, ({expense_acq_in}) => Object.values(({expense_acq_in})).toString()); 
export const s0_expense_acq = ({expense_acq_in}) => s0_expense_acq$m({expense_acq_in})
...
export const s0_lapse_rate$m = memoize(s0_lapse_rate$, ({t_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in}) => Object.values(({t_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in})).toString()); 
export const s0_lapse_rate = ({t_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in}) => s0_lapse_rate$m({t_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in})
...
export const s0_maint_expenses_factor$m = memoize(s0_maint_expenses_factor$, ({maint_expenses_factor_in}) => Object.values(({maint_expenses_factor_in})).toString()); 
export const s0_maint_expenses_factor = ({maint_expenses_factor_in}) => s0_maint_expenses_factor$m({maint_expenses_factor_in})
model['s0_maint_expenses_factor'] = s0_maint_expenses_factor

export const s0_expense_maint$m = memoize(s0_expense_maint$, ({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in}) => Object.values(({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in})).toString()); 
export const s0_expense_maint = ({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in}) => s0_expense_maint$m({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in})
...
export const s0_inflation_factor$m = memoize(s0_inflation_factor$, ({t_in, duration_mth_0_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in}) => Object.values(({t_in, duration_mth_0_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in})).toString()); 
export const s0_inflation_factor = ({t_in, duration_mth_0_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in}) => s0_inflation_factor$m({t_in, duration_mth_0_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in})
...
export const s0_pv_pols_if$m = memoize(s0_pv_pols_if$, ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, premium_payment_frequency_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, premium_payment_frequency_in})).toString()); 
export const s0_pv_pols_if = ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, premium_payment_frequency_in}) => s0_pv_pols_if$m({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, premium_payment_frequency_in})
...
export const s0_premium_due$m = memoize(s0_premium_due$, ({premium_payment_frequency_in, t_in, duration_mth_0_in}) => Object.values(({premium_payment_frequency_in, t_in, duration_mth_0_in})).toString()); 
export const s0_premium_due = ({premium_payment_frequency_in, t_in, duration_mth_0_in}) => s0_premium_due$m({premium_payment_frequency_in, t_in, duration_mth_0_in})
model['s0_premium_due'] = s0_premium_due

export const s0_premium_pp$m = memoize(s0_premium_pp$, ({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => Object.values(({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})).toString()); 
export const s0_premium_pp = ({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => s0_premium_pp$m({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})
...
export const s0_mort_rate_recalc$m = memoize(s0_mort_rate_recalc$, ({age_at_entry_in, duration_mth_0_in, t_in, sex_in}) => Object.values(({age_at_entry_in, duration_mth_0_in, t_in, sex_in})).toString()); 
export const s0_mort_rate_recalc = ({age_at_entry_in, duration_mth_0_in, t_in, sex_in}) => s0_mort_rate_recalc$m({age_at_entry_in, duration_mth_0_in, t_in, sex_in})
model['s0_mort_rate_recalc'] = s0_mort_rate_recalc

export const s0_mort_rate$m = memoize(s0_mort_rate$, ({t_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in}) => Object.values(({t_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in})).toString()); 
export const s0_mort_rate = ({t_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in}) => s0_mort_rate$m({t_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in})
...
export const s0_premium_pp_0$m = memoize(s0_premium_pp_0$, ({premium_payment_frequency_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => Object.values(({premium_payment_frequency_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})).toString()); 
export const s0_premium_pp_0 = ({premium_payment_frequency_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => s0_premium_pp_0$m({premium_payment_frequency_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})
model['s0_premium_pp_0'] = s0_premium_pp_0

export const s0_status$m = memoize(s0_status$, ({duration_mth_0_in}) => Object.values(({duration_mth_0_in})).toString()); 
export const s0_status = ({duration_mth_0_in}) => s0_status$m({duration_mth_0_in})
model['s0_status'] = s0_status

export const s0_net_cf$m = memoize(s0_net_cf$, ({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in}) => Object.values(({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in})).toString()); 
export const s0_net_cf = ({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in}) => s0_net_cf$m({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in})
...
export const s0_policy_value$m = memoize(s0_policy_value$, ({policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in}) => Object.values(({policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in})).toString()); 
export const s0_policy_value = ({policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in}) => s0_policy_value$m({policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in})
...
export const s1_duration_mth$m = memoize(s1_duration_mth$, ({duration_mth_0_in, t_in}) => Object.values(({duration_mth_0_in, t_in})).toString()); 
export const s1_duration_mth = ({duration_mth_0_in, t_in}) => s1_duration_mth$m({duration_mth_0_in, t_in})
model['s1_duration_mth'] = s1_duration_mth

export const s1_duration_mth_0$m = memoize(s1_duration_mth_0$, ({duration_mth_0_in}) => Object.values(({duration_mth_0_in})).toString()); 
export const s1_duration_mth_0 = ({duration_mth_0_in}) => s1_duration_mth_0$m({duration_mth_0_in})
model['s1_duration_mth_0'] = s1_duration_mth_0

export const s1_duration$m = memoize(s1_duration$, ({duration_mth_0_in, t_in}) => Object.values(({duration_mth_0_in, t_in})).toString()); 
export const s1_duration = ({duration_mth_0_in, t_in}) => s1_duration$m({duration_mth_0_in, t_in})
model['s1_duration'] = s1_duration

export const s1_age$m = memoize(s1_age$, ({age_at_entry_in, duration_mth_0_in, t_in}) => Object.values(({age_at_entry_in, duration_mth_0_in, t_in})).toString()); 
export const s1_age = ({age_at_entry_in, duration_mth_0_in, t_in}) => s1_age$m({age_at_entry_in, duration_mth_0_in, t_in})
model['s1_age'] = s1_age
...
export const s1_mort_rate_select_index$m = memoize(s1_mort_rate_select_index$, ({duration_mth_0_in, t_in}) => Object.values(({duration_mth_0_in, t_in})).toString()); 
export const s1_mort_rate_select_index = ({duration_mth_0_in, t_in}) => s1_mort_rate_select_index$m({duration_mth_0_in, t_in})
...
export const s1_mort_rate_mth$m = memoize(s1_mort_rate_mth$, ({t_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in}) => Object.values(({t_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in})).toString()); 
export const s1_mort_rate_mth = ({t_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in}) => s1_mort_rate_mth$m({t_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, duration_mth_0_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in})
model['s1_mort_rate_mth'] = s1_mort_rate_mth

export const s1_lapse_rate_$m = memoize(s1_lapse_rate_$, ({duration_mth_0_in, t_in}) => Object.values(({duration_mth_0_in, t_in})).toString()); 
export const s1_lapse_rate_ = ({duration_mth_0_in, t_in}) => s1_lapse_rate_$m({duration_mth_0_in, t_in})
model['s1_lapse_rate_'] = s1_lapse_rate_

export const s1_lapse_rate_mth$m = memoize(s1_lapse_rate_mth$, ({t_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in}) => Object.values(({t_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in})).toString()); 
export const s1_lapse_rate_mth = ({t_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in}) => s1_lapse_rate_mth$m({t_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, duration_mth_0_in, lapse_rate_factor_in})
...
export const s1_pols_if_at$m = memoize(s1_pols_if_at$, ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})).toString()); 
export const s1_pols_if_at = ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => s1_pols_if_at$m({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})
model['s1_pols_if_at'] = s1_pols_if_at

export const s1_pols_lapse$m = memoize(s1_pols_lapse$, ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})).toString()); 
export const s1_pols_lapse = ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => s1_pols_lapse$m({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})
model['s1_pols_lapse'] = s1_pols_lapse

export const s1_pols_maturity$m = memoize(s1_pols_maturity$, ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})).toString()); 
export const s1_pols_maturity = ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => s1_pols_maturity$m({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})
model['s1_pols_maturity'] = s1_pols_maturity

export const s1_pols_new_biz$m = memoize(s1_pols_new_biz$, ({duration_mth_0_in, t_in, policy_count_in}) => Object.values(({duration_mth_0_in, t_in, policy_count_in})).toString()); 
export const s1_pols_new_biz = ({duration_mth_0_in, t_in, policy_count_in}) => s1_pols_new_biz$m({duration_mth_0_in, t_in, policy_count_in})
model['s1_pols_new_biz'] = s1_pols_new_biz

export const s1_pols_death$m = memoize(s1_pols_death$, ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in})).toString()); 
export const s1_pols_death = ({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in}) => s1_pols_death$m({duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in})
...
export const s1_inflation_factor_$m = memoize(s1_inflation_factor_$, ({t_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in}) => Object.values(({t_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in})).toString()); 
export const s1_inflation_factor_ = ({t_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in}) => s1_inflation_factor_$m({t_in, stress_delay_in, inflation_rate_in, inflation_rate_addition_in})
model['s1_inflation_factor_'] = s1_inflation_factor_

export const s1_premiums$m = memoize(s1_premiums$, ({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => Object.values(({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})).toString()); 
export const s1_premiums = ({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => s1_premiums$m({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})
model['s1_premiums'] = s1_premiums

export const s1_claims$m = memoize(s1_claims$, ({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in}) => Object.values(({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in})).toString()); 
export const s1_claims = ({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in}) => s1_claims$m({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in})
model['s1_claims'] = s1_claims

export const s1_expenses_acq$m = memoize(s1_expenses_acq$, ({expense_acq_in, duration_mth_0_in, t_in, policy_count_in}) => Object.values(({expense_acq_in, duration_mth_0_in, t_in, policy_count_in})).toString()); 
export const s1_expenses_acq = ({expense_acq_in, duration_mth_0_in, t_in, policy_count_in}) => s1_expenses_acq$m({expense_acq_in, duration_mth_0_in, t_in, policy_count_in})
model['s1_expenses_acq'] = s1_expenses_acq

export const s1_expenses_maint$m = memoize(s1_expenses_maint$, ({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => Object.values(({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})).toString()); 
export const s1_expenses_maint = ({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => s1_expenses_maint$m({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})
model['s1_expenses_maint'] = s1_expenses_maint

export const s1_expenses$m = memoize(s1_expenses$, ({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => Object.values(({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})).toString()); 
export const s1_expenses = ({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => s1_expenses$m({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})
model['s1_expenses'] = s1_expenses

export const s1_commissions$m = memoize(s1_commissions$, ({duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in}) => Object.values(({duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in})).toString()); 
export const s1_commissions = ({duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in}) => s1_commissions$m({duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in})
...
export const s1_net_cf_ = ({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in}) => s1_net_cf_$m({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in})
model['s1_net_cf_'] = s1_net_cf_

export const s1_proj_len$m = memoize(s1_proj_len$, ({policy_term_in, duration_mth_0_in}) => Object.values(({policy_term_in, duration_mth_0_in})).toString()); 
export const s1_proj_len = ({policy_term_in, duration_mth_0_in}) => s1_proj_len$m({policy_term_in, duration_mth_0_in})
model['s1_proj_len'] = s1_proj_len

export const s1_is_active$m = memoize(s1_is_active$, ({duration_mth_0_in, t_in, policy_term_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in})).toString()); 
export const s1_is_active = ({duration_mth_0_in, t_in, policy_term_in}) => s1_is_active$m({duration_mth_0_in, t_in, policy_term_in})
model['s1_is_active'] = s1_is_active

export const s1_pols_if$m = memoize(s1_pols_if$, ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})).toString()); 
export const s1_pols_if = ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in}) => s1_pols_if$m({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in})
...
export const s1_pv_claims$m = memoize(s1_pv_claims$, ({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in}) => Object.values(({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in})).toString()); 
export const s1_pv_claims = ({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in}) => s1_pv_claims$m({sum_assured_in, duration_mth_0_in, t_in, policy_term_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in})
model['s1_pv_claims'] = s1_pv_claims

export const s1_pv_premiums$m = memoize(s1_pv_premiums$, ({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => Object.values(({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})).toString()); 
export const s1_pv_premiums = ({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => s1_pv_premiums$m({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})
model['s1_pv_premiums'] = s1_pv_premiums

export const s1_pv_expenses$m = memoize(s1_pv_expenses$, ({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in}) => Object.values(({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in})).toString()); 
export const s1_pv_expenses = ({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in}) => s1_pv_expenses$m({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in})
model['s1_pv_expenses'] = s1_pv_expenses

export const s1_pv_expenses_maint$m = memoize(s1_pv_expenses_maint$, ({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in}) => Object.values(({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in})).toString()); 
export const s1_pv_expenses_maint = ({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in}) => s1_pv_expenses_maint$m({t_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, duration_mth_0_in, inflation_rate_in, inflation_rate_addition_in, policy_term_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in})
model['s1_pv_expenses_maint'] = s1_pv_expenses_maint

export const s1_pv_expenses_acq$m = memoize(s1_pv_expenses_acq$, ({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, discounting_on_in}) => Object.values(({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, discounting_on_in})).toString()); 
export const s1_pv_expenses_acq = ({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, discounting_on_in}) => s1_pv_expenses_acq$m({expense_acq_in, duration_mth_0_in, t_in, policy_count_in, discounting_on_in})
model['s1_pv_expenses_acq'] = s1_pv_expenses_acq

export const s1_pv_commissions$m = memoize(s1_pv_commissions$, ({duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in}) => Object.values(({duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in})).toString()); 
export const s1_pv_commissions = ({duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in}) => s1_pv_commissions$m({duration_mth_0_in, t_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in})
model['s1_pv_commissions'] = s1_pv_commissions

export const s1_pv_net_cf$m = memoize(s1_pv_net_cf$, ({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in}) => Object.values(({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in})).toString()); 
export const s1_pv_net_cf = ({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in}) => s1_pv_net_cf$m({premium_payment_frequency_in, t_in, duration_mth_0_in, sum_assured_in, loading_prem_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in})
model['s1_pv_net_cf'] = s1_pv_net_cf

export const s1_pv_pols_if_$m = memoize(s1_pv_pols_if_$, ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in}) => Object.values(({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in})).toString()); 
export const s1_pv_pols_if_ = ({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in}) => s1_pv_pols_if_$m({duration_mth_0_in, t_in, policy_term_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in})
model['s1_pv_pols_if_'] = s1_pv_pols_if_

export const s1_pv_fut_claims$m = memoize(s1_pv_fut_claims$, ({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in})).toString()); 
export const s1_pv_fut_claims = ({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in}) => s1_pv_fut_claims$m({t_in, policy_term_in, duration_mth_0_in, sum_assured_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in})
model['s1_pv_fut_claims'] = s1_pv_fut_claims

export const s1_pv_fut_premiums$m = memoize(s1_pv_fut_premiums$, ({t_in, policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})).toString()); 
export const s1_pv_fut_premiums = ({t_in, policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in}) => s1_pv_fut_premiums$m({t_in, policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in})
model['s1_pv_fut_premiums'] = s1_pv_fut_premiums

export const s1_pv_fut_expenses$m = memoize(s1_pv_fut_expenses$, ({t_in, policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in})).toString()); 
export const s1_pv_fut_expenses = ({t_in, policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in}) => s1_pv_fut_expenses$m({t_in, policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in})
model['s1_pv_fut_expenses'] = s1_pv_fut_expenses

export const s1_pv_fut_expenses_maint$m = memoize(s1_pv_fut_expenses_maint$, ({t_in, policy_term_in, duration_mth_0_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in})).toString()); 
export const s1_pv_fut_expenses_maint = ({t_in, policy_term_in, duration_mth_0_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in}) => s1_pv_fut_expenses_maint$m({t_in, policy_term_in, duration_mth_0_in, stress_delay_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, timing_in, policy_count_in, zero_decrement_experience_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in})
model['s1_pv_fut_expenses_maint'] = s1_pv_fut_expenses_maint

export const s1_pv_fut_expenses_acq$m = memoize(s1_pv_fut_expenses_acq$, ({t_in, policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, discounting_on_in, zero_spot_year_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, discounting_on_in, zero_spot_year_in})).toString()); 
export const s1_pv_fut_expenses_acq = ({t_in, policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, discounting_on_in, zero_spot_year_in}) => s1_pv_fut_expenses_acq$m({t_in, policy_term_in, duration_mth_0_in, expense_acq_in, policy_count_in, discounting_on_in, zero_spot_year_in})
model['s1_pv_fut_expenses_acq'] = s1_pv_fut_expenses_acq

export const s1_pv_fut_commissions$m = memoize(s1_pv_fut_commissions$, ({t_in, policy_term_in, duration_mth_0_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in})).toString()); 
export const s1_pv_fut_commissions = ({t_in, policy_term_in, duration_mth_0_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in}) => s1_pv_fut_commissions$m({t_in, policy_term_in, duration_mth_0_in, commission_mths_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, commission_pc_in})
model['s1_pv_fut_commissions'] = s1_pv_fut_commissions

export const s1_pv_fut_net_cf$m = memoize(s1_pv_fut_net_cf$, ({t_in, policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in})).toString()); 
export const s1_pv_fut_net_cf = ({t_in, policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in}) => s1_pv_fut_net_cf$m({t_in, policy_term_in, duration_mth_0_in, premium_payment_frequency_in, sum_assured_in, loading_prem_in, pricing_projection_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, original_lapse_rates_in, lapse_rate_factor_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, discounting_on_in, zero_spot_year_in, update_pricing_lapse_rates_in, gender_neutral_pricing_in, expense_acq_in, expense_maint_in, maint_expenses_factor_in, inflation_rate_in, inflation_rate_addition_in, commission_mths_in, commission_pc_in})
model['s1_pv_fut_net_cf'] = s1_pv_fut_net_cf

export const s1_pv_fut_pols_if$m = memoize(s1_pv_fut_pols_if$, ({t_in, policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in}) => Object.values(({t_in, policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in})).toString()); 
export const s1_pv_fut_pols_if = ({t_in, policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in}) => s1_pv_fut_pols_if$m({t_in, policy_term_in, duration_mth_0_in, timing_in, policy_count_in, zero_decrement_experience_in, stress_delay_in, age_at_entry_in, sex_in, mort_rate_factor_in, mort_rate_Y1_add_per_mille_in, original_lapse_rates_in, lapse_rate_factor_in, discounting_on_in, zero_spot_year_in, premium_payment_frequency_in})
...
export const s2_mort_rate_$m = memoize(s2_mort_rate_$, ({age_at_entry_in, duration_mth_0_in, t_in}) => Object.values(({age_at_entry_in, duration_mth_0_in, t_in})).toString()); 
export const s2_mort_rate_ = ({age_at_entry_in, duration_mth_0_in, t_in}) => s2_mort_rate_$m({age_at_entry_in, duration_mth_0_in, t_in})
...
export const inflation_factorw = s1_inflation_factor_; model['inflation_factorw'] = inflation_factorw; ;
export const premiums = s1_premiums; model['premiums'] = premiums; ;
export const claims = s1_claims; model['claims'] = claims; ;
export const expenses_acq = s1_expenses_acq; model['expenses_acq'] = expenses_acq; ;
export const expenses_maint = s1_expenses_maint; model['expenses_maint'] = expenses_maint; ;
...
export const pv_expenses_maint = s1_pv_expenses_maint; model['pv_expenses_maint'] = pv_expenses_maint; ;
export const pv_expenses_acq = s1_pv_expenses_acq; model['pv_expenses_acq'] = pv_expenses_acq; ;
...
export const pv_fut_expenses_maint = s1_pv_fut_expenses_maint; model['pv_fut_expenses_maint'] = pv_fut_expenses_maint; ;
export const pv_fut_expenses_acq = s1_pv_fut_expenses_acq; model['pv_fut_expenses_acq'] = pv_fut_expenses_acq; ;
